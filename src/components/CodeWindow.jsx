...
const CodeWindow = forwardRef(function CodeWindow({ theme, language, font, code, setCode }, ref) {
  return (
    <div
      ref={ref}
      ...
      <div className="code-window w-full h-full rounded-xl overflow-hidden shadow-lg border border-[#333]">
        ...
        <CodeEditor theme={theme.theme} language={language} font={font} code={code} setCode={setCode} />
